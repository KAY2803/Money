...
class Money:
    ...
    def _convert_to_usd(cls, obj: 'Money', valute='USD'):
        """Метод класса, который позволяет конвертировать рубли в доллары США по текущему курсу ЦБ РФ
    ...
    def _convert_to_valute(cls, obj: 'Money', valute: str):
        """Метод класса, который позволяет конвертировать рубли, а также любую валюту из списка valute.json в
